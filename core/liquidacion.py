...
def liquidar_declaracion(cedula_general: dict, cedula_pensiones: dict, dividendos: dict,
                          ...
                          descuentos_tributarios: float = 0, anticipo_renta_anterior: float = 0) -> dict:
    ...
    saldo = total_impuesto_a_cargo + anticipo_renta_anterior - (retenciones or 0)
    ...
    return {
        ...
        "formula": "Total impuesto a cargo + anticipo año anterior - retenciones del año = Saldo a pagar (o a favor si es negativo)",
    }
